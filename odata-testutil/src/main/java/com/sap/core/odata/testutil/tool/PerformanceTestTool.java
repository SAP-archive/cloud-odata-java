...
public class PerformanceTestTool {
   ...
   */
  private void performanceRegressionBaseLineForReadXml(final String supaHome) {
    final List<TestRequest> testRequests = new ArrayList<TestRequest>();

    testRequests.add(TestRequest.createGet("/Employee('1')", 10).addHeader("Accept", "application/atom+xml"));
    testRequests.add(TestRequest.createGet("/Employee('1')", 100).addHeader("Accept", "application/atom+xml"));
    testRequests.add(TestRequest.createGet("/Employee('1')", 1000).addHeader("Accept", "application/atom+xml"));

    testRequests.add(TestRequest.createGet("/Rooms", 10).addHeader("Accept", "application/atom+xml"));
    testRequests.add(TestRequest.createGet("/Rooms", 100).addHeader("Accept", "application/atom+xml"));
    testRequests.add(TestRequest.createGet("/Rooms", 1000).addHeader("Accept", "application/atom+xml"));

    runPerformanceRegressionFor(supaHome, BASELINE_READ_XML_SUPA_CONFIG, testRequests);
  }

  private void performanceRegressionBaseLineForReadJson(final String supaHome) {
    final List<TestRequest> testRequests = new ArrayList<TestRequest>();

    testRequests.add(TestRequest.createGet("/Employee('1')", 10).addHeader("Accept", "application/json"));
    testRequests.add(TestRequest.createGet("/Employee('1')", 100).addHeader("Accept", "application/json"));
    testRequests.add(TestRequest.createGet("/Employee('1')", 1000).addHeader("Accept", "application/json"));

    testRequests.add(TestRequest.createGet("/Rooms", 10).addHeader("Accept", "application/json"));
    testRequests.add(TestRequest.createGet("/Rooms", 100).addHeader("Accept", "application/json"));
    testRequests.add(TestRequest.createGet("/Rooms", 1000).addHeader("Accept", "application/json"));
   ...
   * @param supaHome path in which SUPA is installed
   */
  private void performanceRegressionBaseLineForWrite(final String supaHome) {
    final List<TestRequest> testRequests = new ArrayList<TestRequest>();
    String content = StringHelper.generateData(2048);
    testRequests.add(TestRequest.createPost("/Employees", 10, "application/json", content));
    testRequests.add(TestRequest.createPost("/Employees", 100, "application/json", content));
    testRequests.add(TestRequest.createPost("/Employees", 1000, "application/json", content));

    runPerformanceRegressionFor(supaHome, BASELINE_WRITE_SUPA_CONFIG, testRequests);
  }

  private void runPerformanceRegressionFor(final String supaHome, final String supaConfig, final List<TestRequest> testRequests) {
    try {
   ...
   * @throws IOException
   */
  private void activateLogging(final Level consoleLogLevel, final Level fileLogLevel) throws IOException {
