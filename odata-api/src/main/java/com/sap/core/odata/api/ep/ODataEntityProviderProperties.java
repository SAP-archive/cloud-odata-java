 ...
 * 
 */
public class ODataEntityProviderProperties {
  ...
  private ODataEntityProviderProperties() { }
  ...
  public static class ODataEntityProviderPropertiesBuilder {
    private ODataEntityProviderProperties epOptProperties = new ODataEntityProviderProperties();
    ...
    public final ODataEntityProviderProperties build() {
