...
public class ServiceDocWithExtensionParser implements ServiceDocumentParser {
  ...
  public ServiceDokumentImpl readServiceDokument(final XMLStreamReader reader) throws ServiceDocumentParserException {
  ...
  @Override
  public ServiceDocument parseXml(final InputStream in) throws ServiceDocumentParserException {
