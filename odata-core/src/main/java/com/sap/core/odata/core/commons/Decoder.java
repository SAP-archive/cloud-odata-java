...
public class Decoder {
   ...
   * @throws IllegalArgumentException if the value contains characters outside UTF-8
   *                                  (only checked if at least one percent character is present)
  ...
  public static String decode(final String value) throws IllegalArgumentException, NumberFormatException {
    ...
    //  -1: normal bytes
    //   0: a byte representing the percent character has been read
