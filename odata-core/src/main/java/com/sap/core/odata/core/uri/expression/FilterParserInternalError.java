...
public class FilterParserInternalError extends ODataMessageException {
  ...
  public static final MessageReference INVALID_TOKEN_AT = createMessageReference(FilterParserInternalError.class, "INVALID_TOKEN_AT");
  public static final MessageReference INVALID_TOKENKIND_AT = createMessageReference(FilterParserInternalError.class, "INVALID_TOKENKIND_AT");
  ...
  public static FilterParserInternalError createINVALID_TOKEN_AT(String expectedToken, Token actualToken)
  {
    MessageReference msgRef = FilterParserInternalError.INVALID_TOKEN_AT.create();

    msgRef.addContent(expectedToken);
    msgRef.addContent(actualToken.getUriLiteral());
    msgRef.addContent(actualToken.getPosition());

    return new FilterParserInternalError(msgRef);
  }

  public static FilterParserInternalError createINVALID_TOKENKIND_AT(TokenKind expectedTokenKind, Token actualToken)
  {
    MessageReference msgRef = FilterParserInternalError.INVALID_TOKEN_AT.create();
  ...
  public static FilterParserInternalError createNO_TOKEN_AVAILABLE(String expectedToken)
  {
    MessageReference msgRef = FilterParserInternalError.INVALID_TOKEN_AT.create();
