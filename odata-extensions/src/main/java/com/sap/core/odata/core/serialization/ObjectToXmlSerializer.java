...
//        return swriter.getBuffer().toString();
    ...
    private void writeObjectToStream(XMLStreamWriter writer) throws IllegalAccessException, XMLStreamException {
        writer.writeStartElement(toSerialize.getClass().getSimpleName());
        writer.writeAttribute("package", toSerialize.getClass().getPackage().getName());
        writer.writeStartElement("properties");

        Map<String, Object> objectValues = ObjectHelper.init(toSerialize).getFieldValues();
    ...
    private static class ObjectHelper {
        ...
        private Map<String, Object> mapFieldValueToId(Object object, Map<String, Field> fieldsToIds) 
