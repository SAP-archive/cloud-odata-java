...
<%@page
	import="com.sap.core.odata.processor.fit.JPAReferenceServiceFactory"%>
<%@page import="com.sap.core.odata.processor.fit.util.DataGenerator"%>
<%@page import="javax.naming.InitialContext"%>
<%@page import="javax.naming.NamingException"%>
<%@page import="javax.persistence.EntityManagerFactory"%>
<%@page import="javax.persistence.Persistence"%>
<%@page import="javax.sql.DataSource"%>
<%@page import="org.eclipse.persistence.config.PersistenceUnitProperties"%>
	...
	<table width="100%">
		<tr>
			<td width="70%"><font size=small><b>SalesOrderProcessing
						- Reference Scenario</b></font><small> [<a href="./image/model.jpg"
					target=_blank>Java Persistence Model</a>]
			</small></td>
			<td width="30%">
						...
						<td align="right" width="80%"><font color="green"><small>
									<%
										...
										EntityManagerFactory entityManagerFactory = Persistence
												.createEntityManagerFactory("salesorderprocessing",	properties);
	...
	<div id="s3" style="display: none">
		<table width=100% border="1" cellpadding="3" cellspacing="0">
			...
			<tr>
				...
				<td width=40%><a
					href="SalesOrderProcessing.svc/SalesOrderHeaders(1L)"
					target="_blank">SalesOrderProcessing.svc/SalesOrderHeaders(1L)
				</a></td>
				<td width=40%><code style="font-size: small">SELECT E1
						FROM SalesOrderHeader E1 WHERE E1.soId = 1</code></td>
			</tr>
			<tr>
				...
				<td width=40%><a
					href="SalesOrderProcessing.svc/SalesOrderItems(SoId=1L,LiId=111L)"
					target="_blank">SalesOrderProcessing.svc/SalesOrderItems(SoId=1L,LiId=111L)
				</a></td>
				<td width=40%><code style="font-size: small">SELECT E1
			...
			<tr>
				...
				<td width=40%><a
					href="SalesOrderProcessing.svc/Storages(MaterialId=111L,StoreName='Test_Store_1')"
					target="_blank">SalesOrderProcessing.svc/Storages(MaterialId=111L,StoreName='Test_Store_1')
				</a></td>
				<td width=40%><code style="font-size: small">SELECT E1
						FROM Storage E1 WHERE E1.storageKey.materialId = 111 AND
						E1.storageKey.storeName = 'Test_Store_1'</code></td>
			</tr>
	...
	<div id="s4" style="display: none">
		<table width=100% border="1" cellpadding="3" cellspacing="0">
			...
			<tr>
				...
				<td width=40%><a
					href="SalesOrderProcessing.svc/SalesOrderHeaders(1L)/SalesOrderItemDetails"
					target="_blank">SalesOrderProcessing.svc/SalesOrderHeaders(1L)/SalesOrderItemDetails
				</a></td>
			...
			<tr>
				...
				<td width=40%><a
					href="SalesOrderProcessing.svc/SalesOrderItems(SoId=1L,LiId=111L)/SalesOrderHeaderDetails"
					target="_blank">SalesOrderProcessing.svc/SalesOrderItems(SoId=1L,LiId=111L)/SalesOrderHeaderDetails
				</a></td>
				<td width=40%><code style="font-size: small">SELECT R1
			...
			<tr>
				...
				<td width=40%><a
					href="SalesOrderProcessing.svc/SalesOrderItems(SoId=1L,LiId=111L)/MaterialDetails"
					target="_blank">SalesOrderProcessing.svc/SalesOrderItems(SoId=1L,LiId=111L)/MaterialDetails
				</a></td>
				<td width=40%><code style="font-size: small">SELECT R1
			...
			<tr>
				...
				<td width=40%><a
					href="SalesOrderProcessing.svc/Materials(111L)/StorageDetails"
					target="_blank">SalesOrderProcessing.svc/Materials(111L)/StorageDetails
				</a></td>
				<td width=40%><code style="font-size: small">SELECT R1
						FROM Material E1 JOIN E1.storage R1 WHERE E1.materialId = 111</code></td>
			</tr>

			<tr>
				<td width=20%>Storage-Material (ManyToMany)</td>
				<td width=40%><a
					href="SalesOrderProcessing.svc/Storages(MaterialId=111L,StoreName='Test_Store_1')/MaterialDetails"
					target="_blank">SalesOrderProcessing.svc/Storages(MaterialId=111L,StoreName='Test_Store_1')/MaterialDetails
				</a></td>
				<td width=40%><code style="font-size: small">SELECT R1
						FROM Storage E1 JOIN E1.material R1 WHERE E1.storageKey.materialId
						= 111 AND E1.storageKey.storeName = 'Test_Store_1'</code></td>
			</tr>

			<tr>
				<td width=20%>SalesOrderHeader-SalesOrderItem-Material-Storage
					(Complete Navigation)</td>
				<td width=40%><a
					href="SalesOrderProcessing.svc/SalesOrderHeaders(1L)/SalesOrderItemDetails(SoId=1L,LiId=111L)/MaterialDetails(111L)/StorageDetails"
					target="_blank">SalesOrderProcessing.svc/SalesOrderHeaders(1L)/SalesOrderItemDetails(SoId=1L,LiId=111L)/MaterialDetails(111L)/StorageDetails
				</a></td>
				<td width=40%><code style="font-size: small">SELECT E1
						FROM SalesOrderHeader E1</code></td>
			</tr>
